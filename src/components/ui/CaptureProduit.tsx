...
// L'adresse vit dans `anchors.ts` : elle sert aussi a l'iframe de la Home,
// et une adresse de demonstration ecrite a deux endroits finit par diverger.
const LIEN_PWA = LIEN_DEMO_APP;
