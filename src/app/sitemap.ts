 ...
 * Plan du site.
 *
 * N'y figurent que les pages qui portent du contenu. Les sept coquilles
 * ouvertes par le lot T1 sont en `noindex` tant que leur lot T2 n'est pas
 * fait : les inscrire ici reviendrait a demander leur indexation tout en la
 * refusant dans l'en-tete.
 *
 * Ajouter une route a cette liste au moment ou son contenu arrive, et retirer
 * alors la directive `noindex` de la page.
 */
const AVEC_CONTENU = ['/', '/mentions-legales', '/confidentialite'] as const;
